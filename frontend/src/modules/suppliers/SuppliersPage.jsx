...
import {
  ...
  ShoppingCart, PackageCheck, XCircle, Clock, CheckCircle2
} from 'lucide-react';
    ...
    <div className="flex flex-col -m-4 h-[calc(100%+2rem)] overflow-hidden">
      ...
      <div className="px-4 md:px-6 py-4 border-b bg-white flex items-center justify-between gap-3 flex-wrap">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => activeTab === 'suppliers' ? refetch() : refetchOrders()}
            ...
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-gray-400">
                ...
                <p className="text-lg font-medium">
                  {search ? 'Sin resultados para tu busqueda' : 'Sin proveedores registrados'}
                </p>
                {!search && (
                  <button
                    onClick={() => setFormModal({})}
              ...
              <div className="overflow-hidden rounded-xl border border-gray-200 bg-white">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      {['Nombre', 'Contacto', 'Telefono', 'Email', 'Productos', 'Acciones'].map(h => (
                      ...
                      return (
                        <tr key={o.id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-4 py-3 text-sm text-gray-500">
                            {o.expectedDate ? new Date(o.expectedDate).toLocaleDateString('es-CO') : '—'}
                          </td>
