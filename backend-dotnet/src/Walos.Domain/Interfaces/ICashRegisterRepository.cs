...
public interface ICashRegisterRepository
{
    ...
    Task<CashRegister> CloseAsync(long id, long companyId, long closedBy, decimal closingAmount, string? notes);
    Task<CashMovement> AddMovementAsync(CashMovement movement);
    Task<IEnumerable<CashMovement>> GetMovementsAsync(long cashRegisterId, long companyId);
