...
{
    Task<long?> ResolveBranchAsync(long companyId, long? tenantBranchId, long? requestedBranchId);
    Task<IEnumerable<FinancialCategory>> GetCategoriesAsync(long companyId, string? type = null, long? branchId = null);
    ...
    Task DeleteCategoryAsync(long companyId, long categoryId, long? branchId = null);
    ...
    Task DeleteEntryAsync(long companyId, long entryId, long? branchId = null);
